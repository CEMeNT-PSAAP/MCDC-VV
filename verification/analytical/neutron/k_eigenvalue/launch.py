"""Build and launch the analytical k-eigenvalue verification study."""
...
parser = argparse.ArgumentParser(
    description="Launch the MC/DC VVP analytical neutron k-eigenvalue suite."
)
...
study = {
    "description": {
        "name": "maestro_run",
        "description": "MC/DC verification - analytical neutron - k-eigenvalue suite",
    },
    "env": {"variables": {}},
    "study": steps,
}
